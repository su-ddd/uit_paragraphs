...
<?php
  foreach ($items as $delta => $item) {
    if (($item['#element']['title'] == $item['#element']['url'])) {
      $title = $element['#object']->field_section_title[LANGUAGE_NONE][0]['safe_value'];
      $item['#element']['title'] = "Learn More<span class='element-invisible'> about " . $title . '</span>';
      $item['#element']['html'] = 1;
    }
    print render($item);
  }
